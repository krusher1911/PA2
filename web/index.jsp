                                            ...
                                            <thead class="thead-inverse">
                                                ...
                                                <c:forEach var="produto" items="${produtos}">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button id="${produto.getId()}" type="button" class="editarProduto btn btn-primary btn-sm" onclick="abrirModalEditar(this.id)"><span class="glyphicon glyphicon-edit"></span></button>
                                                            <button id="removerProduto" type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#modalRemover"><span class="glyphicon glyphicon-remove"></span></button>
                                                        </td>
                                                    </tr>
                                                </c:forEach>
