                                                                    ...
                                                                    <thead class="thead-inverse">
                                                                        ...
                                                                        <c:forEach var="produto" items="${produtos}">
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <button id="${produto.getId()}"  name="editorProduto" type="button" class="editarProduto btn btn-primary btn-sm" data-toggle="modal"><span class="glyphicon glyphicon-edit"></span></button>
